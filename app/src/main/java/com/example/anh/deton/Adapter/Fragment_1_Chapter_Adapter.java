...
public class Fragment_1_Chapter_Adapter extends BaseAdapter {

    private String[] mChapter;

    private Context mContext;

    public Fragment_1_Chapter_Adapter(Context context, String[] mContent) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = View.inflate(mContext, R.layout.layout_chapter_of_fragment_1, null);
